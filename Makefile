...
data/domains.federal.csv: data/source/bundde.csv data/source/ifg-bmvi.csv data/source/ifg-dwd.csv data/source/ifg-bmas.csv data/source/ifg-bva.csv data/source/bmf.csv
	echo ${HEADER} > $@
